...
chinUps = Exercise.create(name: 'Chin ups', difficulty: '')
benchDips = Exercise.create(name: 'Bench Dips', difficulty: '')
...
muscleGroupExercise14 = MuscleGroupExercise.create(exercise_id: "14", muscle_group_id: "6")
muscleGroupExercise15 = MuscleGroupExercise.create(exercise_id: "15", muscle_group_id: "7")
muscleGroupExercise16 = MuscleGroupExercise.create(exercise_id: "16", muscle_group_id: "8")
muscleGroupExercise17 = MuscleGroupExercise.create(exercise_id: "17", muscle_group_id: "9")
